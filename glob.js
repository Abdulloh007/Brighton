...
getURL(
    ...
    function (data) {
        ...
        el.innerHTML = data;
        let fetch = el.querySelector('#b-header');
        ...
        linksList = fetch.querySelectorAll('.b-menu');
        ...
        const waitingFor = setInterval(() => {
            if (header == false) {
                // Mobile Menu Srcipt
                const sideBar = document.querySelector('.b-m-menu'),
                sideBarOverlay = document.querySelector('.b-menu_overlay'),
                sideBarBtn = document.querySelector('.b-humburger');
                ...
                const nav = document.querySelectorAll('.b-nav');
                ...
                siteLogo = fetch.querySelectorAll('.b-logo');
...
getURL(
    ...
    function (data) {
        let el = document.createElement('div');
        el.innerHTML = data;
        let fetch = el.querySelector('#b-footer');
